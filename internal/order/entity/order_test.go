...
func TestGivenAValidParams_WhenCreateANewOrder_ThenShouldReceiveCreateOrderWithAllParams(t *testing.T) {
...
func TestGivenAValidParams_WhenICallNewOrderFunc_ThenShouldReceiveCreateOrderWithAllParams(t *testing.T) {
